 ...
 * @author dandy
 */
public class Frame_CreateBrand extends javax.swing.JFrame {
     ...
     */
    public Frame_CreateBrand(Form_Brands formBrands, Home home) {
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Create New Brand");

        jLabelName.setText("Brand Name");
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        if (getjButtonSave().getText().equals("Save")){
            BrandController brand = new BrandController(formBrands, home);
            brand.saveBrand(this);
            brand.showBrands();
        } 
        else {
            BrandController brand = new BrandController(formBrands, home);
            brand.updateBrand(this);
            brand.showBrands();
        }
