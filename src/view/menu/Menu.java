...
import view.swing.scroll.ScrollBar;
...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LIBRARY_BOOKS, "Master Warehouse", "Brands", "Categories", "Racks"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.RECEIPT, "Reports", "Summary Report", "Assets Report"));
...
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Calendar"));
        addTitle("CLIENT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PEOPLE_OUTLINE, "Customers"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.NOTE_ADD, "Tickets"));
...
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.INSERT_EMOTICON, "Icons", "Feather Icons", "Flag Icons", "Mdi Icons"));
        addTitle("WAREHOUSE");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ROUTER, "Assets"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SHOPPING_BASKET, "Delivery Orders"));
...
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ERROR_OUTLINE, "Error", "404", "500"));
        addTitle("ENGINEER");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.WORK, "Activity Reports"));
    }
