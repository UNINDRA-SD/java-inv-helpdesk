...
-- Dumping structure for table inv.brands
...
-- Dumping data for table inv.brands: ~4 rows (approximately)
...
-- Dumping structure for table inv.racks
...
-- Dumping data for table inv.racks: ~3 rows (approximately)
REPLACE INTO `racks` (`id`, `name`) VALUES
	(1, 'RACK A-1'),
	(2, 'RACK A-2'),
	(3, 'RACK B-1');

-- Dumping structure for table inv.users
CREATE TABLE IF NOT EXISTS `users` (
  `id` int NOT NULL AUTO_INCREMENT,
  `email` varchar(50) NOT NULL DEFAULT '0',
  `name` varchar(50) NOT NULL DEFAULT '0',
  `password` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table inv.users: ~4 rows (approximately)
